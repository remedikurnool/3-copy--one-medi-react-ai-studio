            ...
            {scan.variants.map((variant) => {
              ...
              return (
                <div 
                  ...
                  className={`relative bg-white dark:bg-slate-900 rounded-[2.5rem] p-5 shadow-glass border transition-all duration-500 cursor-pointer ${
                    isSelected 
                        ...
                        <div className="flex gap-3 overflow-x-auto no-scrollbar pb-1">
                          {slots.map((slot) => (
                            <button 
                              ...
                              className={`shrink-0 flex flex-col items-center justify-center min-w-[85px] h-[70px] rounded-2xl transition-all duration-300 active:scale-90 border-2 ${
                                selectedSlot === slot 
        ...
        <div className="flex items-center gap-5 max-w-md mx-auto w-full">
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1.5">
              <span className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter">₹{selectedVariant.price}</span>
              <span className="text-xs text-slate-400 line-through font-bold">₹{selectedVariant.mrp}</span>
            </div>
          </div>
          <button 
            onClick={handleBook}

...
export default function ScanList() {
  ...
  const scans = (search.length >= 2 ? searchResults : allScans) || [];
              ...
              >
                <div className="p-6 flex gap-6">
                  <div className="size-24 rounded-3xl bg-slate-50 dark:bg-gray-700 flex items-center justify-center shrink-0 shadow-inner p-4 overflow-hidden">
                    <img src={scan.image_url} alt={scan.name} className="size-full object-cover transition-transform duration-500 hover:scale-110" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-1">
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">{scan.body_part} • 2 Centers</p>
                      </div>

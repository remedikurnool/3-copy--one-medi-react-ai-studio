          ...
          filteredTests.map((test: any) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/20 rounded-md text-[10px] font-black text-blue-500 uppercase tracking-tighter">REPORT: {test.turnaround_time_hours}H</span>
              </div>

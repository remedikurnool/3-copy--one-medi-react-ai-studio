...
export default function LabBooking() {
  ...
  const dates = [
    { id: '14 Oct', label: 'Today', day: '14', month: 'Oct' },
    { id: '15 Oct', label: 'Tue', day: '15', month: 'Oct' },
    { id: '16 Oct', label: 'Wed', day: '16', month: 'Oct' },
    { id: '17 Oct', label: 'Thu', day: '17', month: 'Oct' },
  ];
  ...
  const handleCheckout = () => {
    addToCart({
      id: `lab-test-profile-${selectedDate}-${selectedTime}`,
      type: 'lab',
      ...
      metadata: {
        slot: selectedTime,
        date: selectedDate,
        centerName: serviceType === 'home' ? 'Home Collection' : 'Main Center',
    ...
    <div className="min-h-screen bg-bg-light dark:bg-bg-dark text-slate-900 dark:text-white pb-32 relative flex flex-col font-sans">
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-30 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 p-4 pb-6 shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.1)] max-w-md mx-auto">
        <div className="flex items-center justify-between gap-4">
          ...
          <button onClick={handleCheckout} className="flex-1 h-14 bg-primary hover:bg-primary-dark text-white rounded-xl text-lg font-bold shadow-lg shadow-primary/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
            <span>Checkout</span>

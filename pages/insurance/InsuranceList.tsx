...
export default function InsuranceList() {
    ...
    const handleBuyPlan = (plan: InsurancePlan) => {
        addToCart({
            ...
            qty: 1,
            metadata: {
                slot: 'Verification Pending',
                date: 'Starts on Approval',
                centerName: plan.provider,
                patientName: 'Self'
            }
        });
        navigate('/checkout');
                    ...
                    <div className="p-5 rounded-3xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <button
                                ...
                                className={`${callbackRequested ? 'bg-green-500 text-white' : 'bg-white text-blue-600'} px-5 py-2 rounded-xl text-xs font-black uppercase tracking-widest shadow-md active:scale-95 transition-all flex items-center gap-2`}
                            >
                                {callbackRequested ? (
                                    <>
                        ...
                        <div className="flex items-end justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-primary text-white px-5 h-10 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-primary-dark active:scale-95 transition-transform shadow-lg shadow-primary/30"
                                >
                                    Buy Plan
                                </button>
                            </div>

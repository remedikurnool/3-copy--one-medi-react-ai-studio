...
import { useInsurancePlans, InsurancePlan } from '../../hooks';
...
export default function InsuranceList() {
    ...
    const filteredPlans = (allPlans || []).filter((plan: InsurancePlan) =>
    ...
    return (
        <div className="min-h-screen bg-bg-light dark:bg-bg-dark font-sans text-slate-900 dark:text-white pb-24 relative">
            ...
            <main className="p-4 flex flex-col gap-5">
                ...
                {/* Plans List */}
                {!loading && filteredPlans.map((plan: InsurancePlan) => (
                    ...
                    <div className="bg-white dark:bg-gray-900 w-full max-w-3xl rounded-3xl p-6 max-h-[80vh] overflow-auto relative" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="grid grid-cols-3 min-w-[600px] gap-8">
                            ...
                            <div className="col-span-3 grid grid-cols-4 gap-4 border-b pb-6 border-gray-100 dark:border-gray-800">
                                ...
                                {compareList.map(id => {
                                    const plan = (allPlans || []).find((p: InsurancePlan) => p.id === id);
                                    return (

...
export default function HealthFeed() {
  ...
  // Filtered List (Excluding featured item to avoid duplication in grid if desired, or keep all)
           ...
           <div className="flex gap-2 overflow-x-auto no-scrollbar">
              {tabs.map(tab => (
                 <button 
                   ...
                   className={`h-8 px-4 rounded-full text-xs font-black uppercase tracking-wide whitespace-nowrap transition-all ${
                     activeTab === tab 

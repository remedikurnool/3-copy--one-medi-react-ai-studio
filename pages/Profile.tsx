...
export default function Profile() {
   ...
   const { user } = useAuth();
   const { profile, isAuthenticated, logout, refreshProfile } = useUserStore();
         ...
         <div className="bg-white dark:bg-gray-800 p-6 pb-8 rounded-b-[2.5rem] shadow-sm mb-6 border-b border-gray-100 dark:border-gray-700">
            ...
            <div className="flex items-center gap-5">
               <div className="relative group">
                  <div className="size-20 rounded-2xl bg-gray-200 border-4 border-white dark:border-gray-700 shadow-xl bg-cover bg-center overflow-hidden" style={{ backgroundImage: `url("${profile.avatarUrl}")` }}></div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-8">
               ...
               <div className="bg-purple-50/50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-purple-100/20 dark:border-gray-600">
                  <span className="block text-xl font-black text-purple-600">175</span>
               ...
               <div className="bg-orange-50/50 dark:bg-gray-700/50 p-4 rounded-2xl text-center border border-orange-100/20 dark:border-gray-600">
                  <span className="block text-xl font-black text-orange-600">72</span>

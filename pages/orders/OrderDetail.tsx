        ...
        return (
            <div className="min-h-screen bg-bg-light dark:bg-bg-dark p-4 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate(-1)} className="block mt-4 text-sm text-gray-500">Go Back</button>
                </div>
            </div>
        );
    }
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
                        {items.map((item) => (
                            <div key={item.id} className="py-3 first:pt-0 last:pb-0 flex gap-3">
                                <div className="size-12 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center justify-center shrink-0">
                                    {item.medicine ? (
                                        <img src={item.medicine.image} alt={item.medicine.name} className="size-full object-contain mix-blend-multiply dark:mix-blend-normal rounded-lg p-1" />
                                    ) : item.lab_test ? (

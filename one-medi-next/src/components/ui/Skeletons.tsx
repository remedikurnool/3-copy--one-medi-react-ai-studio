...
// 5. Medicine Detail Page Skeleton
export const MedicineDetailSkeleton = () => (
  <div className="min-h-screen bg-bg-light dark:bg-bg-dark flex flex-col pb-32 animate-pulse">
    <div className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 p-4 flex items-center justify-between">
      <Skeleton className="size-10 rounded-full" />
    ...
    <div className="p-4 flex flex-col gap-6 max-w-2xl mx-auto w-full">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-6 shadow-glass border border-white dark:border-slate-800/50 flex flex-col items-center">
        <Skeleton className="size-48 rounded-[2rem] mb-6" />

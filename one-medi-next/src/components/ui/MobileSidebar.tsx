            ...
            <div className="p-6 bg-primary pt-12 rounded-br-[3rem] shadow-lg relative overflow-hidden">
               ...
               {isAuthenticated ? (
                  ...
                  <div className="relative z-10 mb-6">
                     <h2 className="text-white font-black text-2xl tracking-tight leading-none mb-2">Welcome!</h2>
                     <p className="text-white/80 text-sm mb-4">Login to manage your health</p>
                     <button
                        onClick={() => handleNav('/login')}
                        className="bg-white text-primary px-6 py-2 rounded-xl font-bold text-sm shadow-lg active:scale-95 transition-transform"
                     >
                        Login / Signup
                     </button>
                  </div>
                     ...
                     <button
                        ...
                        onClick={() => {
                           if (!isAuthenticated) {
                              ...
                              handleNav(`/${link.toLowerCase().replace(' ', '-')}`);
                           }
                        }}

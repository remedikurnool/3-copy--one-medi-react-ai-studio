      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-sm border-b border-gray-100 dark:border-gray-800 hidden lg:block">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            <Link href="/notifications" className="size-11 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center text-slate-600 dark:text-gray-300 transition-all active:scale-95">
              <span className="material-symbols-outlined">notifications</span>
            </Link>

            {isAuthenticated ? (
              <Link href="/profile" className="flex items-center gap-3 pl-1 pr-3 py-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-all cursor-pointer border border-transparent hover:border-gray-200">
              ...
              <Link href="/login" className="px-5 py-2.5 rounded-xl text-sm font-bold text-primary bg-primary/10 hover:bg-primary hover:text-white transition-all">
                Login
              </Link>
            )}

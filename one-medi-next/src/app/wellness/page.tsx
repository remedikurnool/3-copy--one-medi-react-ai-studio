...
import { useWellnessServices } from '@/hooks/useServices';
...
export default function WellnessPage() {
    ...
    const { data: services, loading, error } = useWellnessServices();
            ...
            <header className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm border-b border-gray-100 dark:border-gray-800 transition-all">
                <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-xl font-bold tracking-tight leading-none">Wellness Programs</h1>
                ...
                {!loading && filteredServices.map((service: ServiceMaster) => (
                    ...
                    >
                        <div className="flex flex-row gap-4 p-4">
                            <div className="relative size-24 shrink-0 bg-gradient-to-br from-green-400/20 to-teal-400/20 rounded-xl overflow-hidden flex items-center justify-center">
                                <span className="material-symbols-outlined text-4xl text-green-500/50">spa</span>
                            </div>
                            ...
                            <div className="flex flex-col justify-between flex-1 min-w-0">
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300 text-xs leading-relaxed line-clamp-2">
                                        {service.description || 'Wellness and lifestyle management program'}
                                    </p>
                                </div>

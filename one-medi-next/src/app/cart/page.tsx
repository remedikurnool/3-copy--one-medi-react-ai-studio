...
function CartContent() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen mx-auto w-full bg-bg-light dark:bg-bg-dark pb-40 font-sans text-slate-900 dark:text-white overflow-x-hidden">
            <PageHeader
                title="My Cart"
                subtitle={isConciergeMode ? 'Prescription Order' : `${items.length} Items`}
                className="lg:top-20"
                showLocation={false}
            />
            ...
            <div className="p-4 pt-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Left Column: Cart Items & Prescriptions */}
                <div className="lg:col-span-2 flex flex-col gap-6">
                    ...
                    {isConciergeMode && (
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-900/30 dark:to-emerald-900/30 p-5 rounded-[1.5rem] border border-teal-100 dark:border-teal-800/50 flex gap-4 shadow-sm"
                        >
                    ...
                    {!isConciergeMode && finalTotal < 500 && (
                        <motion.div
                            ...
                            className="p-4 bg-white dark:bg-gray-800 rounded-[1.5rem] shadow-sm border border-gray-100 dark:border-gray-700"
                        >
                            ...
                            <AnimatePresence>
                                {items.map((item) => (
                                    <motion.div
                                        ...
                                        className="bg-white dark:bg-gray-800 p-4 rounded-[2rem] shadow-sm border border-slate-50 dark:border-slate-800 flex gap-4 group hover:shadow-card-hover transition-all"
                                    >
                ...
                {/* Right Column: Bill Summary & Checkout (Sticky on Desktop) */}
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-sm border border-slate-100 dark:border-slate-700 relative overflow-hidden lg:sticky lg:top-32">
                        ...
                        {/* Trust Badge */}
                        <div className="flex items-center justify-center gap-2 mt-4 text-slate-400 opacity-60">

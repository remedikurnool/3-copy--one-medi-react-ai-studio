...
const ScanCenterSkeleton = () => (
    <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-6 shadow-sm border border-gray-100 dark:border-gray-700 animate-pulse">
        <div className="flex gap-6">
            <div className="size-24 rounded-3xl bg-gray-200 dark:bg-gray-700 shrink-0"></div>
            ...
            <header className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-sm border-b border-gray-100 dark:border-gray-800">
                <div className="flex flex-col px-4 pt-4 pb-2 gap-3">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.5 bg-primary/10 px-4 py-2 rounded-full cursor-pointer active:scale-95 transition-transform">
                        ...
                        <button onClick={() => router.push('/cart')} className="flex items-center justify-center size-10 -mr-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 relative transition-colors">
                    ...
                    <div className="mt-1">
                        <label className="flex items-center h-12 w-full bg-gray-100 dark:bg-gray-800 rounded-xl px-4 border border-transparent focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/10 transition-all">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-none focus:ring-0 text-base ml-2 placeholder-gray-500 text-slate-900 dark:text-white h-full outline-none"
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start mb-1">
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">{scan.bodyPart} • 2 Centers</p>
                                            </div>
                                            <span className="shrink-0 bg-emerald-100 text-emerald-700 text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider border border-emerald-200">25% OFF</span>
                                        </div>
                                        <div className="h-px bg-slate-50 dark:bg-slate-700/50 w-full my-4"></div>
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <p className="text-[10px] text-slate-400 line-through font-bold">₹{(scan.price * 1.3).toFixed(0)}</p>

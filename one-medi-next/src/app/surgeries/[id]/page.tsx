...
export default function SurgeryDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-surface-50 dark:bg-surface-950 font-sans text-slate-900 dark:text-white pb-32">
            {/* Header Image */}
            ...
            <main className="p-4 flex flex-col gap-6 -mt-2">
                ...
                <div className="grid grid-cols-3 gap-3">
                    <div className="bg-white dark:bg-surface-900 p-3 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-800 text-center">
                        ...
                        <p className="text-xs font-black truncate text-slate-900 dark:text-white">{surgery.hospital}</p>
                    </div>
                    <div className="bg-white dark:bg-surface-900 p-3 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-800 text-center">
                        ...
                        <p className="text-xs font-black text-slate-900 dark:text-white">{surgery.stayDuration}</p>
                    </div>
                    <div className="bg-white dark:bg-surface-900 p-3 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-800 text-center">
                        ...
                        <p className="text-xs font-black text-slate-900 dark:text-white">{surgery.recoveryTime}</p>
                    </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-3xl border border-blue-100 dark:border-blue-800 flex gap-4 items-center">
                    <div className="size-12 rounded-full bg-white dark:bg-surface-800 flex items-center justify-center text-blue-500 shadow-sm shrink-0">
            ...
            {/* Footer Actions */}
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-surface-900 border-t border-surface-200 dark:border-surface-800 z-40 pb-6 shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.1)]">

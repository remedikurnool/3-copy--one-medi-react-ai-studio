...
export default function HomeCareDetailPage() {
    ...
    const handleBook = () => {
        setBookingDraft({
            service: { ...service, title: service.name, image: service.imageUrl || 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800' },
            plan: selectedPlan,
            isHomeVisit: service.isHomeService,
            preferences: { requestFemale }
        });
        router.push('/home-care/booking');
    };
            ...
            <div className="flex-1 overflow-y-auto pb-24">
                ...
                <div className="flex border-b border-surface-200 dark:border-surface-800 bg-white dark:bg-surface-900 p-4 justify-around text-center">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-xs font-bold">{isEquipment ? 'In Stock' : (service.durationMinutes ? `${service.durationMinutes} mins` : 'Flexible')}</span>
                    </div>
                    <div className="w-px bg-gray-100 dark:bg-gray-800"></div>
                    <div className="flex flex-col gap-1">
